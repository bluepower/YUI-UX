	...
	Event.addListener(window, "load", function() {
		...
		var localJSON = function() {
			...
			myDataSource.responseSchema = {
				...
				fields : [ "Id","Name", {key: "Type", parser : "number"} , "Value","DefaultValue","Description","ApplyFrom","ApplyTo",{key: "Domain", parser:fnDomainParser},{key: "Rule", parser:fnRuleParser},"RuleMsg",{key: "Readable", parser : "string"},{key: "Writable", parser : "string"}]
			};
